...
import { DlTextareaControl } from '../../models/control';
...
export class ControlTextareaComponent extends ControlBase<DlTextareaControl> {
	...
	agInit(p: ControlTextareaComponentParams | ICellRendererParams) {
		super.agInit(p);
		this._row = p.node;
		this.inGrid = true;
		this._initalHeight = p.node.rowHeight;
	}
